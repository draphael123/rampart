...
export function buildLevel(world) {
  ...
  statue(22, -30, -120);
  // BANNER GATE: the war-road out of the meadow passes beneath the vale's colours
  block(4.6, -30, -130, 0.55, 5.0, 0.55, C.woodD); block(9.4, -30, -130, 0.55, 5.0, 0.55, C.woodD);
  deco(4.6, -25.0, -130, 0.75, 0.3, 0.75, '#d8b050'); deco(9.4, -25.0, -130, 0.75, 0.3, 0.75, '#d8b050');
  deco(7, -25.35, -130, 5.6, 0.42, 0.42, C.wood);
  deco(5.9, -26.4, -130, 0.9, 1.1, 0.08, '#b03a3a'); deco(7.0, -26.2, -130, 0.9, 1.3, 0.08, '#8a2d2d'); deco(8.1, -26.4, -130, 0.9, 1.1, 0.08, '#b03a3a');
  deco(5.9, -25.85, -130, 0.94, 0.14, 0.1, '#d8b050'); deco(7.0, -25.85, -130, 0.94, 0.14, 0.1, '#d8b050'); deco(8.1, -25.85, -130, 0.94, 0.14, 0.1, '#d8b050');
  tuft(4.1, -30, -129.4); tuft(9.9, -30, -130.6);
  // RUINED CHAPEL: a roofless shell the meadow is slowly taking back
  deco(-25, -29.97, -150, 6.5, 0.06, 5.5, C.stoneL);
  block(-27.6, -30, -150, 0.7, 3.2, 5.4, C.stone);
  deco(-27.62, -27.6, -150, 0.6, 0.9, 1.2, '#1a1418');
  block(-25, -30, -152.4, 4.6, 2.2, 0.7, C.stone);
  block(-25.6, -30, -147.6, 3.4, 1.2, 0.7, C.stoneD);
  block(-22.6, -30, -151.6, 0.7, 2.8, 0.7, C.stone); block(-22.6, -30, -148.4, 0.7, 2.8, 0.7, C.stone);
  deco(-22.6, -27.2, -150, 0.7, 0.55, 3.9, C.stoneD);
  block(-26.4, -30, -150, 1.2, 1.1, 2, C.stoneD);
  deco(-26.4, -28.9, -150, 1.3, 0.12, 2.1, C.stoneL);
  L.torches.push({ x: -26.3, y: -28.5, z: -149.3 }); L.torches.push({ x: -26.3, y: -28.5, z: -150.7 });
  rubble(-23.8, -30, -148.2, 4); rubble(-24.6, -30, -152, 3);
  flowers(-24.4, -30, -149.6, 5); tuft(-23.2, -30, -151.2); tuft(-26.2, -30, -147.4);
